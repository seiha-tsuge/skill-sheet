...
1. バーチャルオフィス（Gather.Town） を利用  対面と遜色ないコミュニケーションをとり、全員フルリモートでの開発環境をよりスムーズなものにしました。
1. チームでの行動指針を定める  定めた指針に従って行動していたか、毎週振り返ることでチームの成長を促しました。
...
まず、要件定義書を基に、顧客の要望を満たす基本設計書を作成しました。
その基本設計書に関して、チームレビュー、リーダーレビュー、元請けレビュー、顧客レビューなど多くの視点から指摘を頂き、考慮不足を認識して成長することができました。
また、その基本設計書をもとに、上流から下流まで一貫したシステム開発を経験することができました。
