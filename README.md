...
そのため、ペアの相手との積極的な雑談や、意見交換を行い、円滑に作業が進むよう邁進しました。
また、毎週のふりかえりを積極的に推進することで、問題の共有と解決を迅速に行うことができ、
さらにはチームに必要な知識を積極的に共有し、学びを吸収することでチームの成長に貢献することができました。
...
その上で、テストリーダーと綿密に協力してテスト観点を考慮したテストケースを作成し、発生したバグの改修に取り組みました。
