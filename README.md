...
| 時期             | 期間    | プロジェクト名                                                                        |
| :--------------- | :------ | :------------------------------------------------------------------------------------ |
| 2022/01〜2024/01 | 24 ヵ月  | [大会サイトプラットフォーム開発](#就職情報システムリプレイス)                             |
...
APIおよびフロントエンドの開発、そして単体テストを実施しました。バックエンド開発では、Flaskを使用して、ユーザー管理機能用のAPIを開発。フロントエンドでは、ゼンリンAPIや内製API(携帯基地局情報や自動車の走行データ)を利用し、これらの情報を地図上に視覚的に表示する機能を組み込みました。この機能によって、ユーザーは地図上で様々なデータを確認できるようになりました。
