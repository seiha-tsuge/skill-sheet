...
| 課題                                  | 解決策                         | 改善                                                                                                                                                               |
| :------------------------------------ | :----------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ソースコードを ZIP ファイルでやりとり | GitHub の導入を働きかける      | ソースコードのバージョン管理ができるようになり、チームの作業効率が向上                                                                                             |
| 開発経験が浅いメンバーが半数以上      | コードレビューの文化を持ち込む | 積極的にフィードバックすることで、チームの技術力向上に貢献する。また、各人が担当した機能以外に関わることが無く属人化していたが、仕様が共有されることで属人化を防止 |

フロントエンド開発の経験を生かして、開発経験が浅いメンバーに積極的にフィードバックすることで、チームの技術力向上に貢献しました。
さらに、 ZIP ファイルのやりとりを GitHub に改めたり、コードレビューの文化を持ち込んだりするなど、業務の効率を上げる工夫を行いました。
