...
| 2019/03〜2019/05 | 3 ヵ月  | [可視化システム(Mobile Data Viewer)](<#可視化システム(Mobile-Data-Viewer)>)           |
...
- Lambda を用いたアプリケーション開発に従事
- AWS Amplify + Vue.js を用いたフロントエンド開発に従事
...
- API 開発、フロントエンド開発、単体テスト
- Django REST framework による API 開発および Wijmo によるフロントエンド開発を担当
